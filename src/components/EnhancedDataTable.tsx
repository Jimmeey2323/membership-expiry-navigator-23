                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="px-6 py-6 text-center">
                          <Badge 
                            variant={member.sessionsLeft > 10 ? "default" : member.sessionsLeft > 3 ? "secondary" : member.sessionsLeft > 0 ? "outline" : "destructive"}
                            className={`font-bold text-base px-4 py-2 ${
                              member.sessionsLeft > 10 ? 'bg-emerald-100 text-emerald-800 border-emerald-300' :
                              member.sessionsLeft > 3 ? 'bg-blue-100 text-blue-800 border-blue-300' :
                              member.sessionsLeft > 0 ? 'bg-amber-100 text-amber-800 border-amber-300' : ''
                            }`}
                          >
                            {member.sessionsLeft}
                          </Badge>
